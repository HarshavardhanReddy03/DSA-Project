let bars = [];
// pink bar denotes ==> traversed bar
// purple bar denotes ==> current traversing bar
// green bar denotes ==> sorted bar
// yellow bar denotes ==> swapping bar(current selecting bar for swapping)
const def = "#fd0081", chng = "#431f91", finished = "#8ef511", selected = "yellow";

// Function invoke to take input from user upon array size and delay time
window.onload = setup();
...
// Function used to stop alteration of array size while sorting
...
// Function used to check whether the array is sorted or not
...
// Function used to generate random array of bars
